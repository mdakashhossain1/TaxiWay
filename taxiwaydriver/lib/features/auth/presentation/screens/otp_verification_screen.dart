...
class _OtpVerificationScreenState extends ConsumerState<OtpVerificationScreen> {
  ...
  Future<void> _verify(String code) async {
    ...
    try {
      ...
      setState(() => _error = msg);
      AppToast.error(context, msg, title: 'Invalid OTP');
  ...
  Future<void> _resend() async {
    ...
    try {
      ...
      if (debugOtp != null) {
        ...
        AppToast.info(context, 'New OTP sent to +91 $phone', title: 'Code Resent');
      }
                ...
                child: IntrinsicHeight(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(l10n.verifyMobileNumber, style: AppTypography.of(context).h1)
                          .animate()
                      ...
                      if (_error != null) ...[
                        ...
                        Center(
                          child: Text(_error!, style: AppTypography.of(context).body.copyWith(color: AppColors.of(context).error, fontWeight: FontWeight.w500)),
                        ),
                      ],
                      ...
                      // Single Clean Primary CTA: "Log In"
                      SizedBox(
                        height: 52,
