                ...
                <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                    <div>
                        ...
                        <div>
                            ...
                            @if ($errors->any())
                                <div class="mb-4 rounded-lg border border-error-300 bg-error-50 px-4 py-3 text-sm text-error-600 dark:border-error-800 dark:bg-error-500/15 dark:text-error-400">
                                    {{ $errors->first() }}
                                </div>
                            @endif
