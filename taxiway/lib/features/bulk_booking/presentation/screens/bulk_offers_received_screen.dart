        ...
        children: [
          Container(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text('${request.pickup.shortName} → ${request.destination.shortName}', style: AppTypography.h3),
          ...
          Text('Vehicles Available', style: AppTypography.h2),
                          ...
                          children: [
                            ...
                            Row(
                              children: [
                                ...
                                Text('${v.rating} · ${v.category} · ${v.seats} Seater', style: AppTypography.caption),
                              ],
                            ),
                          ],
                        ),
